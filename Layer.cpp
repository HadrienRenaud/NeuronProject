...
int Layer::getSize()const{return m_neurons.size();}//nombre de neurones
...
Layer* Layer::getPreviousLayer()const{return m_previousLayer;}
...
bool Layer::isLast()const{return m_nextLayer==0;}//ne pas faire confiance à ces
bool Layer::isFirst()const{return m_previousLayer==0;}//deux fonctions dans le
